...
- Additional unit tests could have been added paired with integration testing.
- Would have been good to move the application to blazor/react.
- Creating a proper db to store values which arent wiped on each run of the application
- Additional features like being able to sort users via each field would be optimal
